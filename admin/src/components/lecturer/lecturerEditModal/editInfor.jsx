...
export default function EditInfor({
  ...
  const onSubmit = async (data) => {
    try {
      setIsLoading(true);
      handleUpdateLecturer(lecturer.code, data);
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className={`${styles.item}`}>
              ...
              <div className="flex flex-col w-2/3">
                <input
                  defaultValue={lecturer.first_name}
                  type="text"
                  placeholder="Nhập họ"
                  className={`${
            ...
            <div className={`${styles.item}`}>
              ...
              <div className="flex flex-col w-2/3">
                <input
                  defaultValue={lecturer.last_name}
                  type="text"
            ...
            <div className={`${styles.item}`}>
              ...
              <div className="flex flex-col w-2/3">
                <input
                  defaultValue={lecturer.phone_number}
                  type="tel"
            ...
            <div className={`${styles.item}`}>
              ...
              <div className="flex flex-col w-2/3">
                <select
                  ...
                  {...register("role_id")}
                >
                  <option value={lecturer.account_id.role_id.id}>{lecturer.account_id.role_id.name}</option>
                </select>
              </div>
            </div>
